...
@Component({
  selector: 'app-odbijene-rez',
  templateUrl: './odbijene-rez.component.html',
  styleUrls: ['./odbijene-rez.component.css']
})
export class OdbijeneRezComponent implements OnInit {
          ...
          this.servis.dohvRezervacijePlan(this.ulogovan._id).subscribe((res:any)=>{
            this.servis.dohvRezervacijePlan(this.ulogovan._id).subscribe((res:any)=>{
              ...
              this.servis.dohvSvePlanTura(this.ulogovan._id).subscribe((res:PlaninskaTura[])=>{
                ...
                console.log(this.odobreneCount);
              })
            })
          })
        }
